...
module.exports = {
  ...
  description: "\`Hiển thị bảng thành tích của nền kinh tế\`",
  usage: "ecolb",
  ...
  if (message.mentions.users.first()) {
    ...
    message.channel.send(`\`Người dùng ${message.mentions.users.first().tag} is number ${output} trên bảng thành tích của tôi\``);
    ...
    eco.Leaderboard({
      ...
      message.channel.send(`\`Bảng xếp hạng đại gia nhà giàu\`:
