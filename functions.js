...
module.exports = {
        ...
        try {
            ...
            for (let i = 0; i < queue.length; i += 10) {
                ...
                const embed = new Discord.MessageEmbed()
                    ...
                    .setDescription(`**Bài hát hiện tại - [\`${queue[0].name}\`](${queue[0].url})**\n\n${info}`)
    ...
    playsongyes: async function(client, message, queue, song) {
        try {
            ...
            .addField("🌀 Hàng chờ:", `>>> \`${queue.songs.length} song(s) - ${queue.formattedDuration}\``, true)
